...
var (
	...
	AWSGovCloudClassic = Platform{
		names: [3]string{"aws-govcloud-classic", "aws-govcloud", "govcloud"},
	}
	AWSGovCloudHCP = Platform{
		names: [3]string{"aws-govcloud-hcp", "aws-govcloud-hosted-cp"},
	}
	GCPClassic = Platform{
...
func ByName(name string) (Platform, error) {
	...
	if slices.Contains(AWSGovCloudHCP.names[:], normalizedName) {
		return AWSGovCloudHCP, nil
	}
...
func (p Platform) IsValid() bool {
	switch p {
	case AWSClassic, AWSHCP, GCPClassic, AWSHCPZeroEgress, AWSGovCloudClassic, AWSGovCloudHCP:
		return true
	default:
		return false
	}
...
func (p Platform) IsAWS() bool {
	switch p {
	case AWSClassic, AWSHCP, AWSHCPZeroEgress, AWSGovCloudClassic, AWSGovCloudHCP:
		return true
	default:
		return false
	}
