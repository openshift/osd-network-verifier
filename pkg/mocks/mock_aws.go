...
func (mr *MockEC2ClientMockRecorder) DeleteKeyPair(ctx, params any, optFns ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, params}, optFns...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteKeyPair", reflect.TypeOf((*MockEC2Client)(nil).DeleteKeyPair), varargs...)
}
...
func (mr *MockEC2ClientMockRecorder) DescribeInstanceTypes(ctx, input any, optFns ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEC2ClientMockRecorder) DescribeVpcAttribute(ctx, input any, optFns ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, input}, optFns...)
...
func (mr *MockEC2ClientMockRecorder) GetConsoleOutput(ctx, input any, optFns ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, input}, optFns...)
...
func (m *MockEC2Client) ModifyInstanceAttribute(ctx context.Context, params *ec2.ModifyInstanceAttributeInput, optFns ...func(*ec2.Options)) (*ec2.ModifyInstanceAttributeOutput, error) {
	...
	ret := m.ctrl.Call(m, "ModifyInstanceAttribute", varargs...)
...
func (mr *MockEC2ClientMockRecorder) ModifyInstanceAttribute(ctx, params any, optFns ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, params}, optFns...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ModifyInstanceAttribute", reflect.TypeOf((*MockEC2Client)(nil).ModifyInstanceAttribute), varargs...)
}
...
func (mr *MockEC2ClientMockRecorder) RunInstances(ctx, params any, optFns ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, params}, optFns...)
...
func (mr *MockEC2ClientMockRecorder) TerminateInstances(ctx, input any, optFns ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, input}, optFns...)
